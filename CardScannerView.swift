...
struct CardScannerView: View {
    ...
    // MARK: - Main Tab Switcher Router (Kept ultra-lightweight)
    var body: some View {
    ...
    // MARK: - Sub-View 1: Isolated Scanner Dashboard Target Container
    ...
    // MARK: - Sub-View 2: Isolated Visual Camera Target Viewport
...
// MARK: - Sub-View 3: Isolated Secure Vault Analytics Target Container
...
let cardNameString = selectedCategory == .sports ? "Michael Jordan Rookie Reprint" : value.cardName
let setNameString = selectedCategory == .sports ? "Fleer Retro (2012)" : value.setName
VStack(alignment: .leading, spacing: 12) {
HStack {
